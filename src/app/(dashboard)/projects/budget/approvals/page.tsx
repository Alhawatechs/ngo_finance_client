...
import { Wallet, Eye, Check } from 'lucide-react'
import {
  getBudgets,
  approveBudget,
  Budget,
  ...
  return (
    <div className="space-y-6">
      <ProjectsPageHeader
        ...
        description="Review and approve budgets submitted for approval"
        breadcrumbs={[{ label: 'Projects', href: '/projects' }, { label: 'Budget', href: '/projects/budget' }, { label: 'Approvals' }]}
      />
        ...
        <CardContent>
          {isLoading ? (
            ...
            <ProjectsEmptyState
              ...
              description="All budgets have been approved. New submissions will appear here."
              action={
                <Link href="/projects/budget/inquiry">
                  <Button variant="outline">View budget inquiry</Button>
                </Link>
              }
            />
          ) : (
