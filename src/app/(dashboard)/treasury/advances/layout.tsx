...
/**
 * Advances module shell (Treasury & Cash): sub-modules are separate sidebar entries
 * under Treasury & Cash → Advances.
 */
export default function AdvancesModuleLayout({ children }: { children: React.ReactNode }) {
